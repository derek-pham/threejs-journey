...
const BlockEnd = ({ position = [0, 0, 0] }) => {
    const hamburger = useGLTF('/models/hamburger2.glb')
    ...
    return (
        <group position={position}>
            ...
            <RigidBody type='fixed' colliders='hull'>
                <primitive object={hamburger.scene} scale={0.2} restitution={0.2} friction={0} position={[0, 0.25, 0]} />
            </RigidBody>
        </group>
    )
}
...
function Level({ count = 5, types = [BlockSpinner, BlockLimbo, BlockAxe], seed = 0 }) {
