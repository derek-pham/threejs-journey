...
import textVertexShaders from '../shaders/ragingseashading/vertex.glsl'
import textFragmentShaders from '../shaders/ragingseashading/fragment.glsl'

const RagingSeaShadingLesson = () => {
    ...
    useEffect(() => {
        ...
        camera.position.set(0.7, 1.5, 1.2)
        scene.add(camera)
...
export default RagingSeaShadingLesson