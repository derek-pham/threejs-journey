...
import { OrbitControls, GLTFLoader, EffectComposer, RenderPass } from 'three/examples/jsm/Addons.js';
import GUI from 'lil-gui';
import { DotScreenPass, GlitchPass, RGBShiftShader, ShaderPass, GammaCorrectionShader, SMAAPass, UnrealBloomPass } from 'three/examples/jsm/Addons.js';
import { uniform } from 'three/examples/jsm/nodes/Nodes.js';

const PostProcessingLesson = () => {
    ...
    useEffect(() => {
        ...
        const renderTarget = new THREE.WebGLRenderTarget(800, 600, {
            samples: renderer.getPixelRatio() === 1 ? 2 : 0 // Reactivate antialias (going up will affect performance)
        })
        ...
        const DisplacementShader = {
            ...
            fragmentShader: `
                ...
                void main() {
                    ...
                    vec2 newUv = vUv + normalColor.xy * 0.05;
        ...
        // Fixes effects that cause dark colours
        const gammaCorrectionPass = new ShaderPass(GammaCorrectionShader)
        effectComposer.addPass(gammaCorrectionPass)

        // DO ANTI-ALIAS AT THE END IF DECIDEDLY SO
